...
<html lang="en">
    ...
    <body>
        ...
        <header id="header">
            <a href="#home" class="header__logo"><img src="static/img/logo.png" alt=""></a>
                ...
                <div class="nav__content bd-grid">
                    ...
                    <div class="nav__menu">
                        <ul class="nav__list">
                            ...
                            <li class="nav__item"><a href="https://www.bolsar.com/VistasDL/PaginaPrincipal.aspx" target="_blank" class="nav__link">Cotizaciones</a></li>
            ...
            <!--
                <a href="#hero"><img src="static/img/logo.png" alt="" class="logo"></a>
                <input type="checkbox" id="nav-toggle" class="nav-toggle">
    
                <nav>
                    <ul class="menu">
                        <li><a href="#home" class="uppercase">Inicio</a></li>
                        <li><a href="#features" class="uppercase">Servicios</a></li>
                        <li><a href="#about-us" class="uppercase">Nosotros</a></li>
                        <li><a href="https://www.bolsar.com/VistasDL/PaginaPrincipal.aspx" target="_blank" class="uppercase">Cotizaciones</a></li>
                        <li><a href="static/pdf/aranceles.pdf" target="_blank" class="uppercase">Aranceles</a></li>
                        <li><a href="#contact" class="uppercase">Contacto</a></li>
                    </ul>
                </nav>
            ...
            <section id="home">
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="5000">
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="carousel-item" style="background-image: url(static/img/hero4.png);">
                            <div class="carousel-caption text-center">
                    ...
                    <div class="about-us__box">
                        ...
                        <div class="about-us__container">
                            ...
                            <h4 class="about-us__description">La firma fue fundada en el año 1923 por el señor Julián Eduardo Mackintosh. En la actualidad es presidida por Raul Mackintosh (Presidente) y Daniel Mackintosh (Vicepresidente).<br>
                                ...
                                <br>
                                La transparencia, la seriedad, la confidencialidad y la atención personalizada son  principales valores que nos avalan como Agente de Liquidación y Negociación Propio, a través de los casi 100 años de actividad ininterrumpida en el Mercado de Capitales. <br>
                                <br>
            ...
            <section class="logos">
                <div class="logo logo1">
                    <a href="https://www.byma.com.ar/" target="_blank">
                        <img src="static/img/footer1.png" alt="">
                    </a>
                </div>
                <div class="logo logo2">
                    <a href="http://www.cadane.com.ar/home.php?v=1" target="_blank">
                        ...
                        <div class="contact__container">
                            <div class="contact__box-info">
                                ...
                                <div class="contact__info-box">
                                    ...
                                    <h4 class="contact__description">macki@macki.sba.com.ar</h4>
                                </div>
                                <div class="contact__info-box">
